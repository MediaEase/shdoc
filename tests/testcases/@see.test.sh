...
# @see https://github.com/MediaEase/shdoc
# @see file://var/log/syslog
# @see shdoc: https://github.com/MediaEase/shdoc
# @see shdoc (https://github.com/MediaEase/shdoc) and https://github.com/reconquest/import.bash
# @see [shdoc](https://github.com/MediaEase/shdoc)
# @see Shell documation generator [shdoc](https://github.com/MediaEase/shdoc).
# @see Shell documation generator [shdoc](https://github.com/MediaEase/shdoc) (and https://github.com/reconquest/import.bash).
test-working-see() {
}
...
* [https://github.com/MediaEase/shdoc](https://github.com/MediaEase/shdoc)
* [file://var/log/syslog](file://var/log/syslog)
* shdoc: [https://github.com/MediaEase/shdoc](https://github.com/MediaEase/shdoc)
* shdoc ([https://github.com/MediaEase/shdoc](https://github.com/MediaEase/shdoc)) and [https://github.com/reconquest/import.bash](https://github.com/reconquest/import.bash)
* [shdoc](https://github.com/MediaEase/shdoc)
* Shell documation generator [shdoc](https://github.com/MediaEase/shdoc).
* Shell documation generator [shdoc](https://github.com/MediaEase/shdoc) (and [https://github.com/reconquest/import.bash](https://github.com/reconquest/import.bash)).
